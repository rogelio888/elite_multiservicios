...
void main() {
  group('CRM Leads Backend & Protocol Integrity Tests', () {
    test(
      'CrmLead model instantiates with proper defaults and serialization',
      () {
    ...
    test(
      'CrmLeadMetricsResponse models aggregated commercial metrics correctly',
      () {
    ...
    test(
      'CrmLead copyWith updates status, temperature and promotion status',
      () {
        final now = DateTime.now().toUtc();
        final lead = CrmLead(
          code: 'PROSP-002',
