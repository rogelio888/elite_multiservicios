...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('elite_multiservicios', '20260912191516390-add-audit-log-page-and-index', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260912191516390-add-audit-log-page-and-index', "timestamp" = now();
