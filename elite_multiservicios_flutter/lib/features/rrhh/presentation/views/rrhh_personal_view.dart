                ...
                ...employees.map((emp) {
                  return TableRow(
                    ...
                    children: [
                      ...
                      // 6: Estado
                      _buildBodyCell(RrhhStatusChip(status: emp.status)),
                      // 7: Acciones
                      _buildBodyCell(
                        Align(
                          alignment: Alignment.centerRight,
                ...
                ...applicants.map((app) {
                  return TableRow(
                    ...
                    children: [
                      ...
                      _buildBodyCell(RrhhStatusChip(status: app.status)),
                      _buildBodyCell(
                        Align(
                          alignment: Alignment.centerRight,
                          child: Row(
                            ...
                            children: [
                              IconButton(
                                ...
                                tooltip: 'Ver detalle',
                                onPressed: () => _openApplicantModal(app),
                              ),
