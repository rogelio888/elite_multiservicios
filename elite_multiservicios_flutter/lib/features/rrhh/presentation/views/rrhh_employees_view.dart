...
class _RrhhEmployeesViewState extends State<RrhhEmployeesView> {
  ...
  final List<EmployeeItem> _employees = [
    ...
    EmployeeItem(
      id: 'emp-26',
      code: 'EMP-026',
      fullName: 'Oscar Eduardo Antelo',
      birthDate: DateTime(1987, 10, 16),
      birthPlace: 'Camiri',
      identityCard: '4691028 SCZ',
      phone: '+591 71029384',
      address: 'Barrio Guaracachi, Calle 4 #19',
      occupation: 'Mecánico Industrial',
      personalReference: 'Miriam Antelo (Esposa)',
      referencePhone: '+591 71011928',
      workplace: 'Segomeit',
      employeeType: 'OPERATIVO',
      position: 'Técnico en Mantenimiento de Maquinaria Industrial',
      department: 'Mantenimiento',
      realStartDate: DateTime(2021, 11, 1),
      fiscalStartDate: DateTime(2021, 11, 15),
      agreedSalary: 4900.0,
      contractType: 'Indefinido',
      observations: 'Alineación de poleas, engrase de rodamientos y mantenimiento de compresores.',
      status: 'ACTIVO',
      hasCiCopy: true,
      hasUtilityBill: true,
      hasHomeSketch: true,
    ...
    EmployeeItem(
      id: 'emp-27',
      code: 'EMP-027',
      fullName: 'Ana María Dorado Peña',
      birthDate: DateTime(1992, 7, 24),
      birthPlace: 'Santa Cruz de la Sierra',
      identityCard: '6192038 SCZ',
      phone: '+591 76391029',
      address: 'Pampa de la Isla, Calle 12 #88',
      occupation: 'Operaria de Lavandería Industrial',
      personalReference: 'José Dorado (Padre)',
      referencePhone: '+591 76300918',
      workplace: 'Kolping - Central',
      employeeType: 'OPERATIVO',
      position: 'Operaria de Lavandería e Higiene Textil',
      department: 'Operaciones',
      realStartDate: DateTime(2023, 8, 15),
      fiscalStartDate: DateTime(2023, 9, 1),
      agreedSalary: 3500.0,
      contractType: 'Indefinido',
      observations: 'Operación de lavadoras y secadoras de capacidad industrial y desmanchado.',
      status: 'ACTIVO',
      hasCiCopy: true,
      hasUtilityBill: true,
      hasHomeSketch: true,
    ...
    EmployeeItem(
      id: 'emp-28',
      code: 'EMP-028',
      fullName: 'Javier Ignacio Saucedo',
      birthDate: DateTime(1995, 3, 11),
      birthPlace: 'Santa Cruz de la Sierra',
      identityCard: '7291028 SCZ',
      phone: '+591 75019284',
      address: 'Av. Banzer, 6to Anillo Condominio Sevilla #14',
      occupation: 'Técnico en Redes y Telecomunicaciones',
      personalReference: 'Claudia Saucedo (Hermana)',
      referencePhone: '+591 75099812',
      workplace: 'Kolping - Central',
      employeeType: 'OPERATIVO',
      position: 'Técnico de Redes y Cableado Estructurado',
      department: 'Sistemas en Sitio',
      realStartDate: DateTime(2023, 10, 1),
      fiscalStartDate: DateTime(2023, 10, 1),
      agreedSalary: 4600.0,
      contractType: 'Indefinido',
      observations: 'Tendido de cable UTP Cat6, mantenimiento de racks y puntos de acceso WiFi.',
      status: 'ACTIVO',
      hasCiCopy: true,
      hasUtilityBill: true,
      hasHomeSketch: true,
    ...
    EmployeeItem(
      id: 'emp-29',
      code: 'EMP-029',
      fullName: 'Sandra Milena Quiroga',
      birthDate: DateTime(1996, 9, 29),
      birthPlace: 'Santa Cruz de la Sierra',
      identityCard: '7910293 SCZ',
      phone: '+591 78019283',
      address: 'Barrio Urbari, Calle Guapay #50',
      occupation: 'Operaria de Pulido y Encerado',
      personalReference: 'Raúl Quiroga (Hermano)',
      referencePhone: '+591 78099182',
      workplace: 'Ventura Mall',
      employeeType: 'OPERATIVO',
      position: 'Operaria de Limpieza y Pulido de Pisos',
      department: 'Operaciones',
      realStartDate: DateTime(2023, 5, 1),
      fiscalStartDate: DateTime(2023, 5, 15),
      agreedSalary: 3700.0,
      contractType: 'Indefinido',
      observations: 'Operación de lustradoras rotativas y abrillantado de porcelanato comercial.',
      status: 'ACTIVO',
      hasCiCopy: true,
      hasUtilityBill: true,
      hasHomeSketch: true,
    ...
    EmployeeItem(
      id: 'emp-30',
      code: 'EMP-030',
      fullName: 'Victor Hugo Chumacero',
      birthDate: DateTime(1989, 4, 15),
      birthPlace: 'Sucre',
      identityCard: '4591028 CHQ',
      phone: '+591 71602938',
      address: 'Barrio Estación Argentina, Calle 3 #22',
      occupation: 'Técnico Aplicador de Plaguicidas',
      personalReference: 'Mónica Chumacero (Esposa)',
      referencePhone: '+591 71699102',
      workplace: 'Kolping - Central',
      employeeType: 'OPERATIVO',
      position: 'Técnico Aplicador en Fumigación y Control de Plagas',
      department: 'Multiservicios',
      realStartDate: DateTime(2022, 6, 1),
      fiscalStartDate: DateTime(2022, 6, 15),
      agreedSalary: 4400.0,
      contractType: 'Indefinido',
      observations: 'Certificado por SEDES para nebulización térmica y control integrado de plagas.',
      status: 'ACTIVO',
      hasCiCopy: true,
      hasUtilityBill: true,
      hasHomeSketch: true,
    ...
    EmployeeItem(
      id: 'emp-31',
      code: 'EMP-031',
      fullName: 'Elizabeth Cardona Vera',
      birthDate: DateTime(1994, 12, 19),
      birthPlace: 'Santa Cruz de la Sierra',
      identityCard: '6910293 SCZ',
      phone: '+591 73819203',
      address: 'Los Lotes, Barrio Palmeras #39',
      occupation: 'Auxiliar de Jardinería',
      personalReference: 'Beatriz Vera (Madre)',
      referencePhone: '+591 73899120',
      workplace: 'Acegal',
      employeeType: 'OPERATIVO',
      position: 'Operaria de Mantenimiento de Patios y Jardines',
      department: 'Jardinería',
      realStartDate: DateTime(2023, 11, 1),
      fiscalStartDate: DateTime(2023, 11, 15),
      agreedSalary: 3500.0,
      contractType: 'Indefinido',
      observations: 'Poda ornamental, recojo de follaje y limpieza de aceras perimetrales.',
      status: 'ACTIVO',
      hasCiCopy: true,
      hasUtilityBill: true,
      hasHomeSketch: true,
    ...
    EmployeeItem(
      id: 'emp-32',
      code: 'EMP-032',
      fullName: 'Luis Fernando Beltrán',
      birthDate: DateTime(1991, 8, 8),
      birthPlace: 'Cochabamba',
      identityCard: '5391028 CBBA',
      phone: '+591 74029381',
      address: 'Villa 1ro de Mayo, Calle 9 #51',
      occupation: 'Auxiliar de Mantenimiento General',
      personalReference: 'Gonzalo Beltrán (Padre)',
      referencePhone: '+591 74011928',
      workplace: 'Segomeit',
      employeeType: 'OPERATIVO',
      position: 'Operario Auxiliar de Mantenimiento General',
      department: 'Mantenimiento',
      realStartDate: DateTime(2023, 7, 1),
      fiscalStartDate: DateTime(2023, 7, 15),
      agreedSalary: 3600.0,
      contractType: 'Indefinido',
      observations: 'Apoyo en albañilería menor, cambio de cerraduras y carpintería básica.',
      status: 'ACTIVO',
      hasCiCopy: true,
      hasUtilityBill: true,
      hasHomeSketch: true,
    ...
    EmployeeItem(
      id: 'emp-33',
      code: 'EMP-033',
      fullName: 'María René Justiniano',
      birthDate: DateTime(1997, 5, 14),
      birthPlace: 'Santa Cruz de la Sierra',
      identityCard: '7391029 SCZ',
      phone: '+591 78910234',
      address: 'Barrio Equipetrol, Calle 5 #77',
      occupation: 'Operaria de Aseo Institucional',
      personalReference: 'René Justiniano (Padre)',
      referencePhone: '+591 78999120',
      workplace: 'Kinesis',
      employeeType: 'OPERATIVO',
      position: 'Operaria de Aseo y Desinfección de Oficinas',
      department: 'Operaciones',
      realStartDate: DateTime(2024, 2, 15),
      fiscalStartDate: DateTime(2024, 3, 1),
      agreedSalary: 3500.0,
      contractType: 'Plazo Fijo',
      observations: 'Limpieza minuciosa en área administrativa y recepción de pacientes.',
      status: 'ACTIVO',
      hasCiCopy: true,
      hasUtilityBill: true,
      hasHomeSketch: true,
    ...
    EmployeeItem(
      id: 'emp-34',
      code: 'EMP-034',
      fullName: 'Edwin Marcelo Claure',
      birthDate: DateTime(1993, 2, 27),
      birthPlace: 'La Paz',
      identityCard: '5819203 LPZ',
      phone: '+591 76019284',
      address: 'Pampa de la Isla, Barrio 23 de Diciembre #10',
      occupation: 'Operario de Limpieza Nocturna',
      personalReference: 'Rosario Claure (Madre)',
      referencePhone: '+591 76088219',
      workplace: 'Ventura Mall',
      employeeType: 'OPERATIVO',
      position: 'Operario de Limpieza y Sanitización Nocturna',
      department: 'Operaciones',
      realStartDate: DateTime(2023, 9, 1),
      fiscalStartDate: DateTime(2023, 9, 15),
      agreedSalary: 3800.0,
      contractType: 'Indefinido',
      observations: 'Turno de 22:00 a 06:00. Limpieza profunda y desengrasado con hidrolavadoras.',
      status: 'ACTIVO',
      hasCiCopy: true,
      hasUtilityBill: true,
      hasHomeSketch: true,
    ...
    EmployeeItem(
      id: 'emp-35',
      code: 'EMP-035',
      fullName: 'Wilson Barrientos Paz',
      birthDate: DateTime(1986, 11, 20),
      birthPlace: 'Santa Cruz de la Sierra',
      identityCard: '4291028 SCZ',
      phone: '+591 71391029',
      address: 'Plan 3000, Calle 11 #305',
      occupation: 'Soldador y Cerrajero Industrial',
      personalReference: 'Laura Paz (Hermana)',
      referencePhone: '+591 71388102',
      workplace: 'Segomeit',
      employeeType: 'OPERATIVO',
      position: 'Técnico en Cerrajería y Soldadura de Mantenimiento',
      department: 'Mantenimiento',
      realStartDate: DateTime(2022, 4, 1),
      fiscalStartDate: DateTime(2022, 4, 15),
      agreedSalary: 4600.0,
      contractType: 'Indefinido',
      observations: 'Soldadura eléctrica y MIG para estructuras metálicas, portones y rejas perimetrales.',
      status: 'ACTIVO',
      hasCiCopy: true,
      hasUtilityBill: true,
      hasHomeSketch: true,
