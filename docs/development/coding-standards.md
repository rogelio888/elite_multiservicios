...
- **Origen de Diseño Mandatorio (Google Stitch)**: Toda pantalla, formulario o componente debe derivar de un prototipo oficial en Google Stitch. Prohibido diseñar layouts desde cero en código.
- **UI & UX Premium**: Seguir las directrices de diseño corporativo moderno definidas en `AppTheme` e importadas desde los tokens de Stitch.
