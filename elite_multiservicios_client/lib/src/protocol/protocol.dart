...
import 'modules/security/models/audit_log_page_response.dart' as _i7;
import 'modules/security/models/mfa_challenge.dart' as _i8;
import 'modules/security/models/mfa_challenge_response.dart' as _i9;
import 'modules/security/models/mfa_verify_response.dart' as _i10;
import 'modules/security/models/role_permission.dart' as _i11;
import 'modules/security/models/server_metrics_response.dart' as _i12;
import 'modules/security/models/trusted_device.dart' as _i13;
import 'modules/security/models/user_role.dart' as _i14;
import 'modules/security/models/user_session.dart' as _i15;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.AuditLogPageResponse) {
      return _i7.AuditLogPageResponse.fromJson(data) as T;
    }
    if (t == _i8.MfaChallenge) {
      return _i8.MfaChallenge.fromJson(data) as T;
    }
    if (t == _i9.MfaChallengeResponse) {
      return _i9.MfaChallengeResponse.fromJson(data) as T;
    }
    if (t == _i10.MfaVerifyResponse) {
      return _i10.MfaVerifyResponse.fromJson(data) as T;
    }
    if (t == _i11.RolePermission) {
      return _i11.RolePermission.fromJson(data) as T;
    }
    if (t == _i12.ServerMetricsResponse) {
      return _i12.ServerMetricsResponse.fromJson(data) as T;
    }
    if (t == _i13.TrustedDevice) {
      return _i13.TrustedDevice.fromJson(data) as T;
    }
    if (t == _i14.UserRole) {
      return _i14.UserRole.fromJson(data) as T;
    }
    if (t == _i15.UserSession) {
      return _i15.UserSession.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i7.AuditLogPageResponse?>()) {
      return (data != null ? _i7.AuditLogPageResponse.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i8.MfaChallenge?>()) {
      return (data != null ? _i8.MfaChallenge.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i9.MfaChallengeResponse?>()) {
      return (data != null ? _i9.MfaChallengeResponse.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i10.MfaVerifyResponse?>()) {
      return (data != null ? _i10.MfaVerifyResponse.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i11.RolePermission?>()) {
      return (data != null ? _i11.RolePermission.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i12.ServerMetricsResponse?>()) {
      return (data != null ? _i12.ServerMetricsResponse.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i13.TrustedDevice?>()) {
      return (data != null ? _i13.TrustedDevice.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i14.UserRole?>()) {
      return (data != null ? _i14.UserRole.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i15.UserSession?>()) {
      return (data != null ? _i15.UserSession.fromJson(data) : null) as T;
    }
    if (t == List<_i6.AuditLog>) {
      return (data as List).map((e) => deserialize<_i6.AuditLog>(e)).toList()
          as T;
    }
    ...
    if (t == List<_i17.AppRole>) {
      return (data as List).map((e) => deserialize<_i17.AppRole>(e)).toList()
          as T;
    }
    if (t == List<_i18.AppPermission>) {
      return (data as List)
              .map((e) => deserialize<_i18.AppPermission>(e))
              .toList()
          as T;
    }
    if (t == List<String>) {
    ...
    if (t == List<_i19.UserSession>) {
      return (data as List)
              .map((e) => deserialize<_i19.UserSession>(e))
              .toList()
          as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i7.AuditLogPageResponse => 'AuditLogPageResponse',
      _i8.MfaChallenge => 'MfaChallenge',
      _i9.MfaChallengeResponse => 'MfaChallengeResponse',
      _i10.MfaVerifyResponse => 'MfaVerifyResponse',
      _i11.RolePermission => 'RolePermission',
      _i12.ServerMetricsResponse => 'ServerMetricsResponse',
      _i13.TrustedDevice => 'TrustedDevice',
      _i14.UserRole => 'UserRole',
      _i15.UserSession => 'UserSession',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i6.AuditLog():
        return 'AuditLog';
      case _i7.AuditLogPageResponse():
        return 'AuditLogPageResponse';
      case _i8.MfaChallenge():
        return 'MfaChallenge';
      case _i9.MfaChallengeResponse():
        return 'MfaChallengeResponse';
      case _i10.MfaVerifyResponse():
        return 'MfaVerifyResponse';
      case _i11.RolePermission():
        return 'RolePermission';
      case _i12.ServerMetricsResponse():
        return 'ServerMetricsResponse';
      case _i13.TrustedDevice():
        return 'TrustedDevice';
      case _i14.UserRole():
        return 'UserRole';
      case _i15.UserSession():
        return 'UserSession';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'AuditLogPageResponse') {
      return deserialize<_i7.AuditLogPageResponse>(data['data']);
    }
    if (dataClassName == 'MfaChallenge') {
      return deserialize<_i8.MfaChallenge>(data['data']);
    }
    if (dataClassName == 'MfaChallengeResponse') {
      return deserialize<_i9.MfaChallengeResponse>(data['data']);
    }
    if (dataClassName == 'MfaVerifyResponse') {
      return deserialize<_i10.MfaVerifyResponse>(data['data']);
    }
    if (dataClassName == 'RolePermission') {
      return deserialize<_i11.RolePermission>(data['data']);
    }
    if (dataClassName == 'ServerMetricsResponse') {
      return deserialize<_i12.ServerMetricsResponse>(data['data']);
    }
    if (dataClassName == 'TrustedDevice') {
      return deserialize<_i13.TrustedDevice>(data['data']);
    }
    if (dataClassName == 'UserRole') {
      return deserialize<_i14.UserRole>(data['data']);
    }
    if (dataClassName == 'UserSession') {
      return deserialize<_i15.UserSession>(data['data']);
    }
